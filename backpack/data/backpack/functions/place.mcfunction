...
summon item_frame ~ ~1 ~ {Facing:1b,Item:{id:"cookie",Count:1,tag:{backpack_gui:1b,CustomModelData:777989}},Invisible:1b,Invulnerable:1b,Tags:[backpack.keeper],Fixed:1b}
