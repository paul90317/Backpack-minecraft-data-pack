...
execute positioned ~ ~-1 ~ as @e[type=item,sort=nearest,limit=1,nbt={Item:{id:"minecraft:cookie",Count:1b,tag:{backpack_gui:1b}}}] run function backpack:keep_inv/26/set_backpack
